...
import type { Project, Tab, LinkIcon, CodeSrc } from "@/data/projects";
...
function TabContent({ tab }: { tab: Tab }) {
	...
	return (
		<motion.div
			...
			className={["flex gap-6 p-12 pb-6 w-full", isLinksTab ? "flex-col mx-auto" : "flex-row items-start"].join(
				" ",
			)}>
			{isLinksTab ? (
			...
			<div className="flex flex-col flex-1 my-6 min-w-0">
				...
				{!collapsed && (
					<>
						...
						{/* Tab navigation */}
						<TabNav tabs={project.tabs} activeId={activeTabId} onSelect={setActiveTabId} />
